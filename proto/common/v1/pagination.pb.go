...
type PaginationRequest struct {
	...
	PageSize      int32                  `protobuf:"varint,2,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"` // 每页大小，默认 20，最大 100
...
const file_common_pagination_proto_rawDesc = "" +
	...
	"totalPagesB:Z8github.com/eidos-exchange/eidos/proto/common/v1;commonv1b\x06proto3"
...
var file_common_pagination_proto_goTypes = []any{
	(*PaginationRequest)(nil),  // 0: eidos.common.v1.PaginationRequest
	(*PaginationResponse)(nil), // 1: eidos.common.v1.PaginationResponse
}
