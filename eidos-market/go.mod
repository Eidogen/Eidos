module github.com/eidos-exchange/eidos/eidos-market
...
replace (
	github.com/eidos-exchange/eidos/eidos-common => ../eidos-common
	github.com/eidos-exchange/eidos/proto => ../proto
)
